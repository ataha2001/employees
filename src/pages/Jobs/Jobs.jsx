...
const Jobs = () => {
  ...
  const { data: allJobs, isLoading, isSuccess, } = useGetJobsQuery();
  const [createData ] = useCreateJobMutation();
  const [updateData ] = useUpdateJobMutation();
  const [deleteData ] = useDeleteJobMutation();
