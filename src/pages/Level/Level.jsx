...
const Levels = () => {
  ...
  const { data: allLevels, isLoading, isSuccess, } = useGetLevelsQuery();
  const [createData ] = useCreateLevelMutation();
  const [updateData ] = useUpdateLevelMutation();
