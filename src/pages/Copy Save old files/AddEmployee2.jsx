...
const AddEmployee = () => {
    ...
    // const { data: departments, isSuccess, isLoading, isFetching , error, undefined} = useGetDepartmentsQuery()
    ...
    const renderDepartments =  allDepartment.map((item, index)=>(
...
//     // const result = await api.endpoints.getData();
//      dataArray = await unwrapResult(departments);
//     // console.log(dataArray);
//   };
    //   if ( isLoading || isFetching ) return <p>Loading ... </p>
//       if ( isLoading || isFetching || !isSuccess || undefined ) {
...
//   }
    ...
    // const dataArray = unwrapResult(departments);
    ...
    //   {!isSuccess && <div  style={{marginTop: '70px'}}>Loading...</div>}
                    ...
                    <Item>
                        <Grid container columnSpacing={1} pr={1}>
                            ...
                            <FormControl sx={{ m: 1, minWidth: 120,  width:'100%', textAlign:'start',  }} size="small">
                                ...
                                name="departmentsId"
                                // value={values.departmentsId ? values.departmentsId : ''}
                                inputRef={inputRefDepartmentsId ? inputRefDepartmentsId : ''}
                                // helperText={isFetching ? 'Loading...' : ''}
