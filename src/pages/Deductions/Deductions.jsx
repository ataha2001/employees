...
const Deductions = () => {
  ...
  const { data: allDeductions, isLoading, isSuccess, } = useGetDeductionsQuery();
  const [createData ] = useCreateDeductionMutation();
  const [updateData ] = useUpdateDeductionMutation();
  const [deleteData ] = useDeleteDeductionMutation();
  ...
  const [confirmDialog, setConfirmDialog] = useState({isOpen:false, title:'', subTitle:''})
    ...
    if (isLoading) {
      ...
      return (
        ...
        <FlexBetween>
          <Header title="Deductions" subtitle="" />
        </FlexBetween>
  ...
  return (
    ...
    <CreateNewAccountModal
      ...
      modalHead="Create New Deduction"
      depData={depData}
