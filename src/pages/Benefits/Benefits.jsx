...
const Benefits = () => {
  ...
  const { data: allBenefits, isLoading, isSuccess, } = useGetBenefitsQuery();
  const [createData ] = useCreateBenefitMutation();
  const [updateData ] = useUpdateBenefitMutation();
  const [deleteData ] = useDeleteBenefitMutation();
  ...
  const [confirmDialog, setConfirmDialog] = useState({isOpen:false, title:'', subTitle:''})
    ...
    if (isLoading) {
      ...
      return (
        ...
        <FlexBetween>
          <Header title="Benefits" subtitle="" />
        </FlexBetween>
